...
for forecast_horizon in forecast_horizon_list:
    ...
    plt.ylim(0.0, 0.4)
    plt.tight_layout()
    plt.savefig(f'retrival_{site_name}.png', format='png', dpi=300) 
    plt.show()
    
    
    
    # Forecast Plot - Validation
    # plt.subplot(3, 1, 2)
    ...
    plt.ylim(0.0, 0.4)
    plt.tight_layout()
    plt.savefig(f'forecasting{site_name}.png', format='png', dpi=300) 
    plt.show()
    ...
    plt.ylim(0.0, 0.4)
    plt.tight_layout()
    plt.savefig(f'combined_{site_name}.png', format='png', dpi=300) 
    plt.show()
    
    # plt.plot(y_train)
    # plt.plot(SMAP_train_norm[lag+forecast_horizon:])
    # plt.show()
    ...
    # Store Unbiased RMSE in Metrics
    ...
    metrics[site_name] = {
        ...
        # "MSE_Retrieval_Train": mse_retrieval_train,
        # "RMSE_Retrieval_Train": rmse_retrieval_train,
        # "MAE_Retrieval_Train": mae_retrieval_train,
        "MSE_Retrieval_Val": mse_retrieval_val,
        "RMSE_Retrieval_Val": rmse_retrieval_val,
        "MAE_Retrieval_Val": mae_retrieval_val,
        # "MSE_Forecast_Train": mse_forecast_train,
        # "RMSE_Forecast_Train": rmse_forecast_train,
        # "MAE_Forecast_Train": mae_forecast_train,
        "MSE_Forecast_Val": mse_forecast_val,
        "RMSE_Forecast_Val": rmse_forecast_val,
        "MAE_Forecast_Val": mae_forecast_val,
        # "MSE_Combined_Train": mse_combined_train,
        # "RMSE_Combined_Train": rmse_combined_train,
        # "MAE_Combined_Train": mae_combined_train,
...
# Save and show plot
plt.tight_layout()
# plt.savefig("ece_metrics_comparison.png", dpi=300)
plt.show()
